    ...
    return(
      <header className="Headborough-div-userinfo"> 
        ...
        <div className="Userinfo">
          <img className="Userpic" src="http://imageog.flaticon.com/icons/png/512/27/27825.png?size=1200x630f&pad=10,10,10,10&ext=png&bg=FFFFFFFF" alt="user profile picture" /> 
        </div>   
      </header>
    );
  }
